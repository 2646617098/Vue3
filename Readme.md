...
今天把登录整出来了，然后发现了vscode里的git功能，还挺方便，在github上整了第一个仓库，但是还不太会用，也不知道是不是网络原因0-0。一直在提交同步，查了一下好像是个bug，那个输入栏必须起个名字，我试一下。wc真的哎，瞬间就提交了0-0。但网络应该也得能上github。然后先提交修改，然后一起推送到github
那岂不是可拿github当云盘了哈哈
